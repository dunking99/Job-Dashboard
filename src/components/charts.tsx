...
export function ActivityChart({
  ...
  // Label every Nth bar. Printing all of them at this width collides them into
  // an unreadable smear of truncated dates; the tooltip carries the rest.
  const labelEvery = data.length > 12 ? 4 : data.length > 8 ? 3 : 1;
          ...
          return (
            ...
            >
              ...
              {(i % labelEvery === 0 || i === data.length - 1) && (
                <span className="pointer-events-none absolute -bottom-[19px] left-1/2 -translate-x-1/2 whitespace-nowrap text-[10px] text-[var(--muted)]">
                  {d.label}
                </span>
              )}
            </div>
